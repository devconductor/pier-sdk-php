...
namespace br.com.conductor.caas.api.v1.invoker;
...
class Configuration
{
     ...
     *
     * @var \br.com.conductor.caas.api.v1.invoker\ApiClient
     */
    ...
    {
        $report  = "PHP SDK (br.com.conductor.caas.api.v1.invoker) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
