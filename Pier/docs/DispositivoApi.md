...
# **listarUsingGET18**
> \br.com.conductor.pier.api.v2.model\PageDispositivoResponse listarUsingGET18($sort, $page, $limit, $token, $id_usuario, $id_aplicacao_mobile, $data_criacao, $data_desativacao)
...
$id_usuario = 789; // int | Identificador do Usu\u00E1rio
$id_aplicacao_mobile = 789; // int | Identificador da aplica\u00E7\u00E3o
...
try { 
    $result = $api_instance->listarUsingGET18($sort, $page, $limit, $token, $id_usuario, $id_aplicacao_mobile, $data_criacao, $data_desativacao);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DispositivoApi->listarUsingGET18: ', $e->getMessage(), "\n";
}
?>
```
...
# **salvarUsingPOST9**
> \br.com.conductor.pier.api.v2.model\DispositivoResponse salvarUsingPOST9($persist)
...
try { 
    ...
    echo 'Exception when calling DispositivoApi->salvarUsingPOST9: ', $e->getMessage(), "\n";
}
?>
```
