...
$rev_user = new \DateTime(); // \DateTime | Usu\u00C3\u00A1rio da auditoria
...
# **listarUsingGET19**
> \br.com.conductor.pier.api.v2.model\PageTipoOprtunidades listarUsingGET19($page, $limit, $descricao, $flag_ativo)
...
try { 
    $result = $api_instance->listarUsingGET19($page, $limit, $descricao, $flag_ativo);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OportunidadesApi->listarUsingGET19: ', $e->getMessage(), "\n";
}
?>
```
...
# **listarUsingGET9**
> \br.com.conductor.pier.api.v2.model\PageOprtunidadesResponse listarUsingGET9($page, $limit, $id_status_oportunidade, $data_cadastro, $data_atualizacao, $numero_receita_federal, $data_inicio_vigencia, $data_fim_vigencia, $flag_ativo)
...
try { 
    $result = $api_instance->listarUsingGET9($page, $limit, $id_status_oportunidade, $data_cadastro, $data_atualizacao, $numero_receita_federal, $data_inicio_vigencia, $data_fim_vigencia, $flag_ativo);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OportunidadesApi->listarUsingGET9: ', $e->getMessage(), "\n";
}
?>
```
...
# **salvarUsingPOST10**
> \br.com.conductor.pier.api.v2.model\TipoOportunidadeResponse salvarUsingPOST10($persist)
...
try { 
    ...
    echo 'Exception when calling OportunidadesApi->salvarUsingPOST10: ', $e->getMessage(), "\n";
}
?>
```
...
# **salvarUsingPOST5**
> \br.com.conductor.pier.api.v2.model\OportunidadeResponse salvarUsingPOST5($persist)
...
try { 
    ...
    echo 'Exception when calling OportunidadesApi->salvarUsingPOST5: ', $e->getMessage(), "\n";
}
?>
```
