# br.com.conductor.pier.api.v1_1.invoker\EstgioCartoApi
...
> \br.com.conductor.pier.api.v1_1.model\EstGioCartO consultarEstagioCartaoUsingGET($id_estagio_cartao)
...
try { 
    ...
    echo 'Exception when calling EstgioCartoApi->consultarEstagioCartaoUsingGET: ', $e->getMessage(), "\n";
}
?>
```
...
[**\br.com.conductor.pier.api.v1_1.model\ListaDeEstGiosCartEs**](ListaDeEstGiosCartEs.md)
