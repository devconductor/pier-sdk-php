...
**data_atendimento** | [**\DateTime**](\DateTime.md) | Apresenta a data em que o Atendimento foi realizado. | [optional] 
**data_agendamento** | [**\DateTime**](\DateTime.md) | Quando utilizado, de acordo com o Tipo de Atendimento, apresenta a data para processamento ou a data para retorno do Atendimento. | [optional] 
**data_processamento** | [**\DateTime**](\DateTime.md) | Quando utilizado, apresenta a data em que a solicita\u00C3\u00A7\u00C3\u00A3o registrada no Atendimento fora processada. | [optional] 
