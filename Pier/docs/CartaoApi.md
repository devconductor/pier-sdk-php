...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CartaoApi();
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Cart\u00E3o (id).
$id_status_impressao = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Status Impress\u00E3o (Id).
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Cart\u00E3o (id). | 
 **id_status_impressao** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Status Impress\u00E3o (Id). | 
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CartaoApi();
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Cart\u00E3o (id)
$id_pessoa = 789; // int | C\u00F3digo de identifica\u00E7\u00E3o de uma Pessoa (id).
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Cart\u00E3o (id) | 
 **id_pessoa** | **int**| C\u00F3digo de identifica\u00E7\u00E3o de uma Pessoa (id). | 
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CartaoApi();
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Cart\u00E3o (id).
$id_status = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Novo Status Cart\u00E3o.
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Cart\u00E3o (id). | 
 **id_status** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Novo Status Cart\u00E3o. | 
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CartaoApi();
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do lote de cart\u00F5es (id)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do lote de cart\u00F5es (id) | 
...
# **consultarUsingGET9**
> \br.com.conductor.pier.api.v2.model\CartaoDetalheResponse consultarUsingGET9($id)
...
try { 
    ...
    echo 'Exception when calling CartaoApi->consultarUsingGET9: ', $e->getMessage(), "\n";
}
?>
```
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CartaoApi();
$id_origem_comercial = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o da Origem Comercial (id).
$id_produto = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Produto (id).
$id_tipo_cartao = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Tipo do Cart\u00E3o (id).
$id_imagem = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o da Imagem (id).
$id_endereco = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Endere\u00E7o (id).
$quantidade_cartoes = 56; // int | N\u00FAmero de cart\u00F5es existentes no Lote.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id_origem_comercial** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o da Origem Comercial (id). | [optional] 
 **id_produto** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Produto (id). | [optional] 
 **id_tipo_cartao** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Tipo do Cart\u00E3o (id). | [optional] 
 **id_imagem** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o da Imagem (id). | [optional] 
 **id_endereco** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Endere\u00E7o (id). | [optional] 
 **quantidade_cartoes** | **int**| N\u00FAmero de cart\u00F5es existentes no Lote. | [optional] 
...
# **listarUsingGET11**
> \br.com.conductor.pier.api.v2.model\PageCartaoResponse listarUsingGET11($sort, $page, $limit, $id_status_cartao, $id_estagio_cartao, $id_conta, $id_pessoa, $id_produto, $tipo_portador, $numero_cartao, $nome_impresso, $data_geracao, $data_status_cartao, $data_estagio_cartao, $data_validade, $data_impressao, $arquivo_impressao, $flag_impressao_origem_comercial, $flag_provisorio, $codigo_desbloqueio, $sequencial_cartao)
...
$page = 56; // int | P\u00E1gina solicitada (Default = 0)
$limit = 56; // int | Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50)
$id_status_cartao = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Status do Cart\u00E3o (id).
$id_estagio_cartao = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Est\u00E1gio de Impress\u00E3o do Cart\u00E3o (id).
$id_conta = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o da Conta a qual o cart\u00E3o pertence (id).
$id_pessoa = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o da Pessoa a qual o cart\u00E3o pertence (id)
$id_produto = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Produto a qual o cart\u00E3o pertence (id).
...
$flag_impressao_origem_comercial = 56; // int | Quando ativa, indica que o cart\u00E3o fora impresso na Origem Comercial.
$flag_provisorio = 56; // int | Quando ativa, indica que o cart\u00E3o \u00E9 provis\u00F3rio. Ou seja, \u00E9 um cart\u00E3o para uso tempor\u00E1rio quando se deseja permitir que o cliente transacione sem que ele tenha recebido um cart\u00E3o definitivo.
...
$sequencial_cartao = 56; // int | N\u00FAmero sequencial do cart\u00E3o

try { 
    $result = $api_instance->listarUsingGET11($sort, $page, $limit, $id_status_cartao, $id_estagio_cartao, $id_conta, $id_pessoa, $id_produto, $tipo_portador, $numero_cartao, $nome_impresso, $data_geracao, $data_status_cartao, $data_estagio_cartao, $data_validade, $data_impressao, $arquivo_impressao, $flag_impressao_origem_comercial, $flag_provisorio, $codigo_desbloqueio, $sequencial_cartao);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CartaoApi->listarUsingGET11: ', $e->getMessage(), "\n";
}
?>
```
 ...
 **page** | **int**| P\u00E1gina solicitada (Default = 0) | [optional] 
 **limit** | **int**| Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50) | [optional] 
 **id_status_cartao** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Status do Cart\u00E3o (id). | [optional] 
 **id_estagio_cartao** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Est\u00E1gio de Impress\u00E3o do Cart\u00E3o (id). | [optional] 
 **id_conta** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o da Conta a qual o cart\u00E3o pertence (id). | [optional] 
 **id_pessoa** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o da Pessoa a qual o cart\u00E3o pertence (id) | [optional] 
 **id_produto** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Produto a qual o cart\u00E3o pertence (id). | [optional] 
 ...
 **flag_impressao_origem_comercial** | **int**| Quando ativa, indica que o cart\u00E3o fora impresso na Origem Comercial. | [optional] 
 **flag_provisorio** | **int**| Quando ativa, indica que o cart\u00E3o \u00E9 provis\u00F3rio. Ou seja, \u00E9 um cart\u00E3o para uso tempor\u00E1rio quando se deseja permitir que o cliente transacione sem que ele tenha recebido um cart\u00E3o definitivo. | [optional] 
...
try { 
    ...
    echo 'Exception when calling CartaoApi->validarCVVUsingPOST: ', $e->getMessage(), "\n";
}
?>
```
