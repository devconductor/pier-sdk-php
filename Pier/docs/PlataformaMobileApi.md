...
# **salvarUsingPOST20**
> \br.com.conductor.pier.api.v2.model\PlataformaMobileResponse salvarUsingPOST20($persist)
...
try { 
    ...
    echo 'Exception when calling PlataformaMobileApi->salvarUsingPOST20: ', $e->getMessage(), "\n";
}
?>
```
