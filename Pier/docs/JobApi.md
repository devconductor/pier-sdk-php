...
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Job (id).
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Job (id). | 
...
# **listarUsingGET26**
> \br.com.conductor.pier.api.v2.model\PageJobResponse listarUsingGET26($groovy, $descricao, $cron, $status, $page, $limit)
...
try { 
    $result = $api_instance->listarUsingGET26($groovy, $descricao, $cron, $status, $page, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling JobApi->listarUsingGET26: ', $e->getMessage(), "\n";
}
?>
```
...
# **salvarUsingPOST15**
> \br.com.conductor.pier.api.v2.model\JobResponse salvarUsingPOST15($descricao, $cron, $groovy)
...
try { 
    $result = $api_instance->salvarUsingPOST15($descricao, $cron, $groovy);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling JobApi->salvarUsingPOST15: ', $e->getMessage(), "\n";
}
?>
```
