# br.com.conductor.pier.api.v2.invoker\AntecipacoesApi
...
try { 
    ...
    echo 'Exception when calling AntecipacoesApi->consultarTaxaAntecipacaoUsingGET: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling AntecipacoesApi->efetivarAntecipacaoUsingPOST: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling AntecipacoesApi->simularAntecipacaoUsingGET: ', $e->getMessage(), "\n";
}
?>
```
