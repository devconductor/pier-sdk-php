...
------------- | ------------- | -------------
[**consultarUsingGET25**](RiscoFraudeApi.md#consultarUsingGET25) | **GET** /api/riscos-fraudes/{id} | Consultar uma transa\u00C3\u00A7\u00C3\u00A3o classificada com risco de fraude
...
# **consultarUsingGET25**
> \br.com.conductor.pier.api.v2.model\RiscoFraudeDetalhadoResponse consultarUsingGET25($id)
...
try { 
    ...
    echo 'Exception when calling RiscoFraudeApi->consultarUsingGET25: ', $e->getMessage(), "\n";
}
?>
```
