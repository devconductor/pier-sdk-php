...
# **consultarUsingGET14**
> \br.com.conductor.pier.api.v2.model\RiscoFraudeDetalhadoResponse consultarUsingGET14($id)
...
try { 
    ...
    echo 'Exception when calling RiscoFraudeApi->consultarUsingGET14: ', $e->getMessage(), "\n";
}
?>
```
