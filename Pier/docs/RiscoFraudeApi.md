...
------------- | ------------- | -------------
[**consultarUsingGET22**](RiscoFraudeApi.md#consultarUsingGET22) | **GET** /api/riscos-fraudes/{id} | Consultar uma transa\u00C3\u00A7\u00C3\u00A3o classificada com risco de fraude
...
# **consultarUsingGET22**
> \br.com.conductor.pier.api.v2.model\RiscoFraudeDetalhadoResponse consultarUsingGET22($id)
...
try { 
    ...
    echo 'Exception when calling RiscoFraudeApi->consultarUsingGET22: ', $e->getMessage(), "\n";
}
?>
```
