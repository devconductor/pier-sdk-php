...
# **listarUsingGET38**
> \br.com.conductor.pier.api.v2.model\PageTipoDebitoRecorrenteResponse listarUsingGET38($sort, $page, $limit, $id, $descricao, $valor, $flag_ativo)
...
try { 
    $result = $api_instance->listarUsingGET38($sort, $page, $limit, $id, $descricao, $valor, $flag_ativo);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DebitoRecorrenteApi->listarUsingGET38: ', $e->getMessage(), "\n";
}
?>
```
