...
try { 
    ...
    echo 'Exception when calling NotificacoesApi->alterarConfiguracaoUsingPUT: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling NotificacoesApi->alterarTemplateNotificacaoUsingPUT: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling NotificacoesApi->consultarConfiguracaoUsingGET: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling NotificacoesApi->consultarTemplateNotificacaoUsingGET: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling NotificacoesApi->gerarTokenUsingPOST: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling NotificacoesApi->listarTiposLayoutsUsingGET: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling NotificacoesApi->salvarConfiguracaoUsingPOST: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling NotificacoesApi->salvarTemplateNotificacaoUsingPOST: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling NotificacoesApi->validarTokenUsingPOST: ', $e->getMessage(), "\n";
}
?>
```
