...
# **listarUsingGET3**
> \br.com.conductor.pier.api.v2.model\PageArquivoResponse listarUsingGET3($sort, $page, $limit, $nome, $id_tipo_arquivo, $id_status_arquivo, $extensao)
...
try { 
    $result = $api_instance->listarUsingGET3($sort, $page, $limit, $nome, $id_tipo_arquivo, $id_status_arquivo, $extensao);
    print_r($result);
} catch (Exception $e) {
