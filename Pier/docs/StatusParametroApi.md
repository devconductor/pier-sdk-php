...
[**consultarUsingGET15**](StatusParametroApi.md#consultarUsingGET15) | **GET** /api/status-contas/{id} | Apresenta os dados de um determinado Status Conta
[**consultarUsingGET16**](StatusParametroApi.md#consultarUsingGET16) | **GET** /api/status-impressoes/{id} | Apresenta os dados de um determinado Status Impress\u00C3\u00A3o
...
[**listarUsingGET22**](StatusParametroApi.md#listarUsingGET22) | **GET** /api/status-contas | Lista os Status Contas cadastrados para o Emissor
[**listarUsingGET23**](StatusParametroApi.md#listarUsingGET23) | **GET** /api/status-impressoes | Lista as op\u00C3\u00A7\u00C3\u00B5es de Status Impress\u00C3\u00A3o
...
# **consultarUsingGET15**
> \br.com.conductor.pier.api.v2.model\StatusContaResponse consultarUsingGET15($id)
...
try { 
    ...
    echo 'Exception when calling StatusParametroApi->consultarUsingGET15: ', $e->getMessage(), "\n";
}
?>
```
...
# **consultarUsingGET16**
> \br.com.conductor.pier.api.v2.model\StatusImpressaoResponse consultarUsingGET16($id)
...
try { 
    ...
    echo 'Exception when calling StatusParametroApi->listarUsingGET22: ', $e->getMessage(), "\n";
}
?>
```
