...
[**consultarUsingGET11**](FAQApi.md#consultarUsingGET11) | **GET** /api/faqs/{id} | Consultar FAQ por id
[**listarUsingGET14**](FAQApi.md#listarUsingGET14) | **GET** /api/faqs | Lista FAQs
...
# **consultarUsingGET11**
> \br.com.conductor.pier.api.v2.model\FaqResponse consultarUsingGET11($id)
...
try { 
    ...
    echo 'Exception when calling FAQApi->consultarUsingGET11: ', $e->getMessage(), "\n";
}
?>
```
...
# **listarUsingGET14**
> \br.com.conductor.pier.api.v2.model\PageFaqResponse listarUsingGET14($sort, $page, $limit, $id_faq, $pergunta, $resposta, $relevancia, $plataforma, $categoria, $status)
...
try { 
    $result = $api_instance->listarUsingGET14($sort, $page, $limit, $id_faq, $pergunta, $resposta, $relevancia, $plataforma, $categoria, $status);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FAQApi->listarUsingGET14: ', $e->getMessage(), "\n";
}
?>
```
