...
# **listarUsingGET22**
> \br.com.conductor.pier.api.v2.model\PageFaqResponse listarUsingGET22($sort, $page, $limit, $id_faq, $pergunta, $resposta, $relevancia, $plataforma, $categoria, $status)
...
try { 
    $result = $api_instance->listarUsingGET22($sort, $page, $limit, $id_faq, $pergunta, $resposta, $relevancia, $plataforma, $categoria, $status);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FAQApi->listarUsingGET22: ', $e->getMessage(), "\n";
}
?>
```
