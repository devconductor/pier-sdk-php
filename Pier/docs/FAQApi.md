...
# **consultarUsingGET12**
> \br.com.conductor.pier.api.v2.model\FaqResponse consultarUsingGET12($id)
...
try { 
    ...
    echo 'Exception when calling FAQApi->consultarUsingGET12: ', $e->getMessage(), "\n";
}
?>
```
...
# **listarUsingGET15**
> \br.com.conductor.pier.api.v2.model\PageFaqResponse listarUsingGET15($sort, $page, $limit, $id_faq, $pergunta, $resposta, $relevancia, $plataforma, $categoria, $status)
...
try { 
    $result = $api_instance->listarUsingGET15($sort, $page, $limit, $id_faq, $pergunta, $resposta, $relevancia, $plataforma, $categoria, $status);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FAQApi->listarUsingGET15: ', $e->getMessage(), "\n";
}
?>
```
