...
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o da campanha (id).
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o da campanha (id). | 
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CadastroGeralApi();
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o da configura\u00E7\u00E3o (id).
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o da configura\u00E7\u00E3o (id). | 
...
try { 
    ...
    echo 'Exception when calling CadastroGeralApi->consultarUsingGET10: ', $e->getMessage(), "\n";
}
?>
```
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CadastroGeralApi();
$id = 789; // int | C\u00F3digo de identifica\u00E7\u00E3o de configura\u00E7\u00E3o rotativo (id).

try { 
    $result = $api_instance->consultarUsingGET11($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->consultarUsingGET11: ', $e->getMessage(), "\n";
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de identifica\u00E7\u00E3o de configura\u00E7\u00E3o rotativo (id). | 
...
# **consultarUsingGET26**
> \br.com.conductor.pier.api.v2.model\ProdutoDetalhesResponse consultarUsingGET26($id)
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CadastroGeralApi();
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Produto (id)
...
# **consultarUsingGET33**
> \br.com.conductor.pier.api.v2.model\PageTipoAjusteResponse consultarUsingGET33($sort, $page, $limit, $id, $descricao)
...
$id = 789; // int | C\u00F3digo identificador do tipo de ajuste.
$descricao = "descricao_example"; // string | Descri\u00E7\u00E3o do tipo de ajuste.

try { 
    $result = $api_instance->consultarUsingGET33($sort, $page, $limit, $id, $descricao);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->consultarUsingGET33: ', $e->getMessage(), "\n";
}
?>
```
...
# **consultarUsingGET34**
> \br.com.conductor.pier.api.v2.model\PageTipoBoletoResponse consultarUsingGET34($sort, $page, $limit, $id, $descricao, $banco)
...
$page = 56; // int | P\u00E1gina solicitada (Default = 0)
$limit = 56; // int | Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50)
$id = 789; // int | C\u00F3digo identificador do tipo de boleto.
$descricao = "descricao_example"; // string | Descri\u00E7\u00E3o do tipo de boleto.
$banco = 789; // int | C\u00F3digo identificador do banco.

try { 
    $result = $api_instance->consultarUsingGET34($sort, $page, $limit, $id, $descricao, $banco);
    print_r($result);
} catch (Exception $e) {
...
# **consultarUsingGET35**
> \br.com.conductor.pier.api.v2.model\TipoEnderecoResponse consultarUsingGET35($id)
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CadastroGeralApi();
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Tipo do Endere\u00E7o (id)

try { 
    $result = $api_instance->consultarUsingGET35($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->consultarUsingGET35: ', $e->getMessage(), "\n";
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Tipo do Endere\u00E7o (id) | 
...
# **consultarUsingGET36**
> \br.com.conductor.pier.api.v2.model\TipoOperacaoResponse consultarUsingGET36($id_cartao, $id_estabelecimento, $codigo_processamento)
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CadastroGeralApi();
$id_cartao = 789; // int | C\u00F3digo de identifica\u00E7\u00E3o do cartao (idCartao).
$id_estabelecimento = 789; // int | C\u00F3digo de identifica\u00E7\u00E3o do estabelecimento (idEstabelecimento).
$codigo_processamento = "codigo_processamento_example"; // string | C\u00F3digo de processamento da opera\u00E7\u00E3o.

try { 
    $result = $api_instance->consultarUsingGET36($id_cartao, $id_estabelecimento, $codigo_processamento);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->consultarUsingGET36: ', $e->getMessage(), "\n";
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id_cartao** | **int**| C\u00F3digo de identifica\u00E7\u00E3o do cartao (idCartao). | 
 **id_estabelecimento** | **int**| C\u00F3digo de identifica\u00E7\u00E3o do estabelecimento (idEstabelecimento). | 
...
# **consultarUsingGET38**
> \br.com.conductor.pier.api.v2.model\TipoTelefoneResponse consultarUsingGET38($id)
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CadastroGeralApi();
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Tipo do Telefone (id)

try { 
    $result = $api_instance->consultarUsingGET38($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->consultarUsingGET38: ', $e->getMessage(), "\n";
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Tipo do Telefone (id) | 
...
# **consultarUsingGET4**
> \br.com.conductor.pier.api.v2.model\AtendimentoClienteResponse consultarUsingGET4($id)
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CadastroGeralApi();
$id = 789; // int | C\u00F3digo de identifica\u00E7\u00E3o do atendimento cliente (id).

try { 
    $result = $api_instance->consultarUsingGET4($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->consultarUsingGET4: ', $e->getMessage(), "\n";
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de identifica\u00E7\u00E3o do atendimento cliente (id). | 
...
# **consultarUsingGET6**
> \br.com.conductor.pier.api.v2.model\BancoResponse consultarUsingGET6($id)
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CadastroGeralApi();
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Banco (id).

try { 
    $result = $api_instance->consultarUsingGET6($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->consultarUsingGET6: ', $e->getMessage(), "\n";
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Banco (id). | 
...
$page = 56; // int | P\u00E1gina solicitada (Default = 0)
$limit = 56; // int | Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50)
$id_tipo_campanha = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do tipo de campanha (id).
 ...
 **page** | **int**| P\u00E1gina solicitada (Default = 0) | [optional] 
 **limit** | **int**| Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50) | [optional] 
 **id_tipo_campanha** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do tipo de campanha (id). | [optional] 
...
# **listarUsingGET13**
> \br.com.conductor.pier.api.v2.model\ConfiguracaoRegistroCobrancaResponse listarUsingGET13($sort, $page, $limit)
...
try { 
    $result = $api_instance->listarUsingGET13($sort, $page, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->listarUsingGET13: ', $e->getMessage(), "\n";
}
?>
```
...
# **listarUsingGET14**
> \br.com.conductor.pier.api.v2.model\PageConfiguracaoRotativoResponse listarUsingGET14($sort, $page, $limit, $id_produto)
...
$page = 56; // int | P\u00E1gina solicitada (Default = 0)
$limit = 56; // int | Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50)
$id_produto = 789; // int | C\u00F3digo de identifica\u00E7\u00E3o do Produto.

try { 
    $result = $api_instance->listarUsingGET14($sort, $page, $limit, $id_produto);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->listarUsingGET14: ', $e->getMessage(), "\n";
}
?>
```
...
# **listarUsingGET34**
> \br.com.conductor.pier.api.v2.model\PagePortadorResponse listarUsingGET34($sort, $page, $limit, $id_conta, $id_produto, $id_pessoa, $id_parentesco, $tipo_portador, $nome_impresso, $id_tipo_cartao, $flag_ativo, $data_cadastro_portador, $data_cancelamento_portador)
...
$id_parentesco = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Parentesco (id)
...
$id_tipo_cartao = 789; // int | Apresenta o c\u00F3digo de identifica\u00E7\u00E3o do tipo do cart\u00E3o (id), que ser\u00E1 utilizado para gerar os cart\u00F5es deste portador, vinculados a sua respectiva conta atrav\u00E9s do campo idConta.
$flag_ativo = 56; // int | Quanto ativa, indica que o cadastro do Portador est\u00E1 ativo, em emissores que realizam este tipo de gest\u00E3o.
...
try { 
    $result = $api_instance->listarUsingGET34($sort, $page, $limit, $id_conta, $id_produto, $id_pessoa, $id_parentesco, $tipo_portador, $nome_impresso, $id_tipo_cartao, $flag_ativo, $data_cadastro_portador, $data_cancelamento_portador);
    print_r($result);
} catch (Exception $e) {
...
# **listarUsingGET35**
> \br.com.conductor.pier.api.v2.model\PageProdutoResponse listarUsingGET35($sort, $page, $limit, $nome, $status, $id_fantasia_basica)
...
$id_fantasia_basica = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o da Fantasia B\u00E1sica (id) a qual o produto pertence.

try { 
    $result = $api_instance->listarUsingGET35($sort, $page, $limit, $nome, $status, $id_fantasia_basica);
    print_r($result);
} catch (Exception $e) {
...
# **listarUsingGET36**
> \br.com.conductor.pier.api.v2.model\PagePromotorResponse listarUsingGET36($sort, $page, $limit, $id, $nome, $data_cadastro, $id_estabelecimento, $id_usuario)
...
$page = 56; // int | P\u00E1gina solicitada (Default = 0)
$limit = 56; // int | Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50)
$id = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do promotor (id)
...
$id_usuario = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do usu\u00E1rio

try { 
    $result = $api_instance->listarUsingGET36($sort, $page, $limit, $id, $nome, $data_cadastro, $id_estabelecimento, $id_usuario);
    print_r($result);
} catch (Exception $e) {
...
# **listarUsingGET44**
> \br.com.conductor.pier.api.v2.model\PageTipoEnderecoResponse listarUsingGET44($sort, $page, $limit, $id, $nome)
...
try { 
    $result = $api_instance->listarUsingGET44($sort, $page, $limit, $id, $nome);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->listarUsingGET44: ', $e->getMessage(), "\n";
}
?>
```
...
# **listarUsingGET46**
> \br.com.conductor.pier.api.v2.model\PageTipoTelefoneResponse listarUsingGET46($sort, $page, $limit, $id, $nome)
...
try { 
    $result = $api_instance->listarUsingGET46($sort, $page, $limit, $id, $nome);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->listarUsingGET46: ', $e->getMessage(), "\n";
}
?>
```
 ...
 **page** | **int**| P\u00E1gina solicitada (Default = 0) | [optional] 
 **limit** | **int**| Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50) | [optional] 
 **id** | **int**| C\u00F3digo de Identifica\u00E7\u00E3o do Tipo do Telefone (id). | [optional] 
...
# **listarUsingGET52**
> \br.com.conductor.pier.api.v2.model\PageControleVencimentoResponse listarUsingGET52($sort, $page, $limit, $data_vencimento)
...
try { 
    $result = $api_instance->listarUsingGET52($sort, $page, $limit, $data_vencimento);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->listarUsingGET52: ', $e->getMessage(), "\n";
}
?>
```
...
# **listarUsingGET6**
> \br.com.conductor.pier.api.v2.model\PageAtendimentoClienteResponse listarUsingGET6($sort, $page, $limit, $id_tipo_atendimento, $id_conta, $nome_atendente, $data_atendimento)
...
$page = 56; // int | P\u00E1gina solicitada (Default = 0)
$limit = 56; // int | Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50)
$id_tipo_atendimento = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o do Tipo de Atendimento (id)
$id_conta = 789; // int | C\u00F3digo de identifica\u00E7\u00E3o de conta (id).
...
try { 
    $result = $api_instance->listarUsingGET6($sort, $page, $limit, $id_tipo_atendimento, $id_conta, $nome_atendente, $data_atendimento);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->listarUsingGET6: ', $e->getMessage(), "\n";
}
?>
```
 ...
 **id_conta** | **int**| C\u00F3digo de identifica\u00E7\u00E3o de conta (id). | [optional] 
...
# **listarUsingGET8**
> \br.com.conductor.pier.api.v2.model\PageBancoResponse listarUsingGET8($sort, $page, $limit)
...
try { 
    $result = $api_instance->listarUsingGET8($sort, $page, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CadastroGeralApi->listarUsingGET8: ', $e->getMessage(), "\n";
}
?>
```
...
$api_instance = new br.com.conductor.pier.api.v2.invoker\Api\CadastroGeralApi();
$id_conta = 789; // int | C\u00F3digo de Identifica\u00E7\u00E3o da Conta a qual o Atendimento est\u00E1 associado
...
try { 
    ...
    echo 'Exception when calling CadastroGeralApi->salvarUsingPOST5: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    ...
    echo 'Exception when calling CadastroGeralApi->salvarUsingPOST7: ', $e->getMessage(), "\n";
}
?>
```
