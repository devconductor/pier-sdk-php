...
class OrigemComercialApi
{
     ...
     * @return \br.com.conductor.pier.api.v1_1.model\ListaDeOrigensComerciais
     * @throws \br.com.conductor.pier.api.v1_1.invoker\ApiException on non-2xx response
     */
     ...
     * @param int $page P\u00C3\u00A1gina solicitada (Default = 0) (optional)
     * @param int $limit Limite de elementos por solicita\u00C3\u00A7\u00C3\u00A3o (Default = 100, Max = 100) (optional)
     * @return Array of \br.com.conductor.pier.api.v1_1.model\ListaDeOrigensComerciais, HTTP status code, HTTP response headers (array of strings)
     * @throws \br.com.conductor.pier.api.v1_1.invoker\ApiException on non-2xx response
     */
    public function listarOrigensComerciaisUsingGETWithHttpInfo($id_origem_comercial = null, $nome = null, $status = null, $page = null, $limit = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\br.com.conductor.pier.api.v1_1.model\ListaDeOrigensComerciais'
            );
            ...
            return array(\br.com.conductor.pier.api.v1_1.invoker\ObjectSerializer::deserialize($response, '\br.com.conductor.pier.api.v1_1.model\ListaDeOrigensComerciais', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \br.com.conductor.pier.api.v1_1.invoker\ObjectSerializer::deserialize($e->getResponseBody(), '\br.com.conductor.pier.api.v1_1.model\ListaDeOrigensComerciais', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
