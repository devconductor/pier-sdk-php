...
class StatusImpressaoApi
{
     ...
     * @return \br.com.conductor.pier.api.v1_1.model\StatusImpressao
     * @throws \br.com.conductor.pier.api.v1_1.invoker\ApiException on non-2xx response
     */
    public function consultarUsingGET3($id_status_impressao)
    {
        list($response, $statusCode, $httpHeader) = $this->consultarUsingGET3WithHttpInfo ($id_status_impressao);
        return $response; 
    }
     ...
     *
     * @param int $id_status_impressao C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Status de Impress\u00C3\u00A3o do Cart\u00C3\u00A3o (id). (required)
     * @return Array of \br.com.conductor.pier.api.v1_1.model\StatusImpressao, HTTP status code, HTTP response headers (array of strings)
     * @throws \br.com.conductor.pier.api.v1_1.invoker\ApiException on non-2xx response
     */
    public function consultarUsingGET3WithHttpInfo($id_status_impressao)
    {
        
        // verify the required parameter 'id_status_impressao' is set
        if ($id_status_impressao === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id_status_impressao when calling consultarUsingGET3');
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\br.com.conductor.pier.api.v1_1.model\StatusImpressao'
            );
            ...
            return array(\br.com.conductor.pier.api.v1_1.invoker\ObjectSerializer::deserialize($response, '\br.com.conductor.pier.api.v1_1.model\StatusImpressao', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \br.com.conductor.pier.api.v1_1.invoker\ObjectSerializer::deserialize($e->getResponseBody(), '\br.com.conductor.pier.api.v1_1.model\StatusImpressao', $e->getResponseHeaders());
     ...
     * @return \br.com.conductor.pier.api.v1_1.model\PageStatusImpressao
     * @throws \br.com.conductor.pier.api.v1_1.invoker\ApiException on non-2xx response
     */
     ...
     * @param int $page P\u00C3\u00A1gina solicitada (Default = 0) (optional)
     * @param int $limit Limite de elementos por solicita\u00C3\u00A7\u00C3\u00A3o (Default = 100, Max = 100) (optional)
     * @return Array of \br.com.conductor.pier.api.v1_1.model\PageStatusImpressao, HTTP status code, HTTP response headers (array of strings)
     * @throws \br.com.conductor.pier.api.v1_1.invoker\ApiException on non-2xx response
     */
    public function listarUsingGET3WithHttpInfo($id = null, $nome = null, $page = null, $limit = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\br.com.conductor.pier.api.v1_1.model\PageStatusImpressao'
            );
            ...
            return array(\br.com.conductor.pier.api.v1_1.invoker\ObjectSerializer::deserialize($response, '\br.com.conductor.pier.api.v1_1.model\PageStatusImpressao', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \br.com.conductor.pier.api.v1_1.invoker\ObjectSerializer::deserialize($e->getResponseBody(), '\br.com.conductor.pier.api.v1_1.model\PageStatusImpressao', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
