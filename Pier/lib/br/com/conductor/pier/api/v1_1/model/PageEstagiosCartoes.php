...
use \ArrayAccess;
/**
 * PageEstagiosCartoes Class Doc Comment
 *
 * @category    Class
 * @description Page de Est\u00C3\u00A1gios Cart\u00C3\u00B5es
 * @package     br.com.conductor.pier.api.v1_1.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PageEstagiosCartoes implements ArrayAccess
{
    /**
    ...
    static $setters = array(
        'estagio_cartoes' => 'setEstagioCartoes'
    );
    ...
    static $getters = array(
        'estagio_cartoes' => 'getEstagioCartoes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            $this->estagio_cartoes = $data["estagio_cartoes"];
        }
    }
    ...
    public function setEstagioCartoes($estagio_cartoes)
    {
        ...
        $this->estagio_cartoes = $estagio_cartoes;
        return $this;
    }
