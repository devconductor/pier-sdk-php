...
use \ArrayAccess;
/**
 * OportunidadePersistValue_ Class Doc Comment
 *
 * @category    Class
 * @description {{{oportunidade_persist_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OportunidadePersistValue_ implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'flag_ativo' => 'bool',
        'detalhes' => '\br.com.conductor.pier.api.v2.model\DetalheOportunidadePersistValue_[]'
    );
    ...
    /**
      * $id_tipo_oportunidade {{{oportunidade_persist_id_tipo_oportunidade_value}}}
      * @var int
      */
    protected $id_tipo_oportunidade;
    
    /**
      * $id_status_oportunidade {{{oportunidade_persist_id_status_oportunidade_value}}}
      * @var int
      */
    protected $id_status_oportunidade;
    
    /**
      * $numero_receita_federal {{{oportunidade_persist_numero_receita_federal_value}}}
      * @var string
      */
    protected $numero_receita_federal;
    
    /**
      * $data_inicio_vigencia {{{oportunidade_persist_data_inicio_vigencia_value}}}
      * @var string
      */
    protected $data_inicio_vigencia;
    
    /**
      * $data_fim_vigencia {{{oportunidade_persist_data_fim_vigencia_value}}}
      * @var string
      */
    protected $data_fim_vigencia;
    
    /**
      * $flag_ativo {{{oportunidade_persist_flag_ativo_value}}}
      * @var bool
      */
    protected $flag_ativo;
    
    /**
      * $detalhes {{{oportunidade_persist_detalhes_value}}}
      * @var \br.com.conductor.pier.api.v2.model\DetalheOportunidadePersistValue_[]
      */
    protected $detalhes;
     ...
     * @param int $id_tipo_oportunidade {{{oportunidade_persist_id_tipo_oportunidade_value}}}
     * @return $this
     */
     ...
     * @param int $id_status_oportunidade {{{oportunidade_persist_id_status_oportunidade_value}}}
     * @return $this
     */
     ...
     * @param string $numero_receita_federal {{{oportunidade_persist_numero_receita_federal_value}}}
     * @return $this
     */
     ...
     * @param string $data_inicio_vigencia {{{oportunidade_persist_data_inicio_vigencia_value}}}
     * @return $this
     */
     ...
     * @param string $data_fim_vigencia {{{oportunidade_persist_data_fim_vigencia_value}}}
     * @return $this
     */
    ...
    /**
     * Sets flag_ativo
     * @param bool $flag_ativo {{{oportunidade_persist_flag_ativo_value}}}
     * @return $this
     */
    ...
    /**
     * Gets detalhes
     * @return \br.com.conductor.pier.api.v2.model\DetalheOportunidadePersistValue_[]
     */
    ...
    /**
     * Sets detalhes
     * @param \br.com.conductor.pier.api.v2.model\DetalheOportunidadePersistValue_[] $detalhes {{{oportunidade_persist_detalhes_value}}}
     * @return $this
     */
