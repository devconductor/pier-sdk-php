...
/**
 * GlobaltaxasrefinanciamentoApi Class Doc Comment
 *
 * @category Class
 * @package  br.com.conductor.pier.api.v2.invoker
 * @author   http://github.com/swagger-api/swagger-codegen
...
class GlobaltaxasrefinanciamentoApi
{
     ...
     * @return GlobaltaxasrefinanciamentoApi
     */
     ...
     * @param int $id {{{taxas_refinanciamento_request_id_value}}} (optional)
     * @param int $id_produto {{{taxas_refinanciamento_request_id_produto_value}}} (optional)
     * @param string $data_entrada {{{taxas_refinanciamento_request_data_entrada_value}}} (optional)
     * @param string $vencimento {{{taxas_refinanciamento_request_vencimento_value}}} (optional)
     * @return \br.com.conductor.pier.api.v2.model\PageTaxasRefinanciamentoResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function listarUsingGET51($sort = null, $page = null, $limit = null, $id = null, $id_produto = null, $data_entrada = null, $vencimento = null)
    {
        list($response, $statusCode, $httpHeader) = $this->listarUsingGET51WithHttpInfo ($sort, $page, $limit, $id, $id_produto, $data_entrada, $vencimento);
        return $response; 
    }
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function listarUsingGET51WithHttpInfo($sort = null, $page = null, $limit = null, $id = null, $id_produto = null, $data_entrada = null, $vencimento = null)
    {
        
  
        // parse inputs
        $resourcePath = "/api/taxas-refinanciamento";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        if ($data_entrada !== null) {
            $queryParams['dataEntrada'] = $this->apiClient->getSerializer()->toQueryValue($data_entrada);
        }// query params
        
        if ($vencimento !== null) {
            $queryParams['vencimento'] = $this->apiClient->getSerializer()->toQueryValue($vencimento);
        }
