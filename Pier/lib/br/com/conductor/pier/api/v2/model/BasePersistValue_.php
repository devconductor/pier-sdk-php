...
use \ArrayAccess;
/**
 * BasePersistValue_ Class Doc Comment
 *
 * @category    Class
 * @description {{{base_persist_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BasePersistValue_ implements ArrayAccess
{
    /**
    ...
    /**
      * $criado_por {{{base_dto_criado_por_value}}}
      * @var string
      */
    ...
    /**
     * Sets senha
     * @param string $senha {{{base_dto_senha_value}}}
     * @return $this
     */
    ...
    /**
     * Sets criado_por
     * @param string $criado_por {{{base_dto_criado_por_value}}}
     * @return $this
     */
