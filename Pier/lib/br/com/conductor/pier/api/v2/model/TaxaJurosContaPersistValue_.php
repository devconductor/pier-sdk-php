...
use \ArrayAccess;
/**
 * TaxaJurosContaPersistValue_ Class Doc Comment
 *
 * @category    Class
 * @description {{{taxa_juros_conta_persist_value}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TaxaJurosContaPersistValue_ implements ArrayAccess
{
    /**
    ...
    /**
      * $numero_meses_carencia {{{taxa_juros_conta_update_numero_meses_carencia_value}}}
      * @var int
      */
    protected $numero_meses_carencia;
    
    /**
      * $taxa_juros {{{taxa_juros_conta_update_taxa_juros_value}}}
      * @var Number
      */
     ...
     * @param int $numero_meses_carencia {{{taxa_juros_conta_update_numero_meses_carencia_value}}}
     * @return $this
     */
    ...
    /**
     * Sets taxa_juros
     * @param Number $taxa_juros {{{taxa_juros_conta_update_taxa_juros_value}}}
     * @return $this
     */
