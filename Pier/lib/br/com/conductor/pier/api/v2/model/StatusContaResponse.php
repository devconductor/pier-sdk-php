 ...
 *
 * @category    Class
 * @description {{{status_conta_response_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
...
class StatusContaResponse implements ArrayAccess
{
    ...
    /**
      * $id {{{status_conta_response_id_value}}}
      * @var int
      */
    protected $id;
    
    /**
      * $nome {{{status_conta_response_nome_value}}}
      * @var string
      */
    protected $nome;
    
    /**
      * $permite_alterar_vencimento {{{status_conta_response_permite_alterar_vencimento_value}}}
      * @var int
      */
    protected $permite_alterar_vencimento;
    
    /**
      * $permite_alterar_limite {{{status_conta_response_permite_alterar_limite_value}}}
      * @var int
      */
    protected $permite_alterar_limite;
    
    /**
      * $permite_emitir_nova_via_cartao {{{status_conta_response_permite_emitir_nova_via_cartao_value}}}
      * @var int
      */
    protected $permite_emitir_nova_via_cartao;
    
    /**
      * $permite_fazer_transferencia {{{status_conta_response_permite_fazer_transferencia_value}}}
      * @var int
      */
    protected $permite_fazer_transferencia;
    
    /**
      * $permite_receber_transferencia {{{status_conta_response_permite_receber_transferencia_value}}}
      * @var int
      */
    protected $permite_receber_transferencia;
    
    /**
      * $permite_criar_acordo_cobranca {{{status_conta_response_permite_criar_acordo_cobranca_value}}}
      * @var int
      */
    protected $permite_criar_acordo_cobranca;
    
    /**
      * $permite_atribuir_como_bloqueio {{{status_conta_response_permite_atribuir_como_bloqueio_value}}}
      * @var int
      */
    protected $permite_atribuir_como_bloqueio;
    
    /**
      * $permite_desbloquear {{{status_conta_response_permite_desbloquear_value}}}
      * @var int
      */
    protected $permite_desbloquear;
    
    /**
      * $permite_atribuir_como_cancelamento {{{status_conta_response_permite_atribuir_como_cancelamento_value}}}
      * @var int
      */
    ...
    /**
     * Sets id
     * @param int $id {{{status_conta_response_id_value}}}
     * @return $this
     */
    ...
    /**
     * Sets nome
     * @param string $nome {{{status_conta_response_nome_value}}}
     * @return $this
     */
     ...
     * @param int $permite_alterar_vencimento {{{status_conta_response_permite_alterar_vencimento_value}}}
     * @return $this
     */
     ...
     * @param int $permite_alterar_limite {{{status_conta_response_permite_alterar_limite_value}}}
     * @return $this
     */
     ...
     * @param int $permite_emitir_nova_via_cartao {{{status_conta_response_permite_emitir_nova_via_cartao_value}}}
     * @return $this
     */
     ...
     * @param int $permite_fazer_transferencia {{{status_conta_response_permite_fazer_transferencia_value}}}
     * @return $this
     */
     ...
     * @param int $permite_receber_transferencia {{{status_conta_response_permite_receber_transferencia_value}}}
     * @return $this
     */
     ...
     * @param int $permite_criar_acordo_cobranca {{{status_conta_response_permite_criar_acordo_cobranca_value}}}
     * @return $this
     */
     ...
     * @param int $permite_atribuir_como_bloqueio {{{status_conta_response_permite_atribuir_como_bloqueio_value}}}
     * @return $this
     */
     ...
     * @param int $permite_desbloquear {{{status_conta_response_permite_desbloquear_value}}}
     * @return $this
     */
     ...
     * @param int $permite_atribuir_como_cancelamento {{{status_conta_response_permite_atribuir_como_cancelamento_value}}}
     * @return $this
     */
