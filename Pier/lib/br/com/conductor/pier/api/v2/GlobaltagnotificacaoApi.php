...
/**
 * GlobaltagnotificacaoApi Class Doc Comment
 *
 * @category Class
 * @package  br.com.conductor.pier.api.v2.invoker
 * @author   http://github.com/swagger-api/swagger-codegen
...
class GlobaltagnotificacaoApi
{
     ...
     * @return GlobaltagnotificacaoApi
     */
     ...
     * @param string $conteudo {{{notificacao_resource_alterar_template_notificacao_param_conteudo}}} (required)
     * @param int $id_configuracao_email {{{template_notificacao_persist_id_configuracao_email_value}}} (optional)
     * @param string $tipo_layout {{{template_notificacao_persist_tipo_layout_value}}} (optional)
     * @param string $tipo_notificacao {{{template_notificacao_persist_tipo_notificacao_value}}} (optional)
     * @param string $remetente {{{template_notificacao_persist_remetente_value}}} (optional)
     * @param string $assunto {{{template_notificacao_persist_assunto_value}}} (optional)
     * @param bool $template_padrao {{{template_notificacao_persist_template_padrao_value}}} (optional)
     ...
     *
     * @param string $nsu {{{notificacao_resource_atualizar_s_m_s_param_nsu}}} (optional)
     * @param string $status {{{notificacao_resource_atualizar_s_m_s_param_status}}} (optional)
     * @param string $data {{{notificacao_resource_atualizar_s_m_s_param_data}}} (optional)
     * @param string $texto_status {{{notificacao_resource_atualizar_s_m_s_param_texto_status}}} (optional)
     * @param string $operadora {{{notificacao_resource_atualizar_s_m_s_param_operadora}}} (optional)
     ...
     * @param int $page {{{global_menssagem_sort_page_value}}} (optional)
     * @param int $limit {{{global_menssagem_sort_limit}}} (optional)
     * @param string $data_envio {{{notificacao_push_request_data_envio_value}}} (optional)
     * @param string $tipo_evento {{{notificacao_push_request_tipo_evento_value}}} (optional)
     * @param string $status {{{notificacao_push_request_status_value}}} (optional)
     * @param string $plataforma {{{notificacao_push_request_plataforma_value}}} (optional)
     * @param string $protocolo {{{notificacao_push_request_protocolo_value}}} (optional)
     ...
     * @param int $page {{{global_menssagem_sort_page_value}}} (optional)
     * @param int $limit {{{global_menssagem_sort_limit}}} (optional)
     * @param string $data_inclusao {{{notificacao_s_m_s_request_data_inclusao_value}}} (optional)
     * @param string $tipo_evento {{{notificacao_s_m_s_request_tipo_evento_value}}} (optional)
     * @param string $status {{{notificacao_s_m_s_request_status_value}}} (optional)
     * @param string $operadora {{{notificacao_s_m_s_request_operadora_value}}} (optional)
     * @param string $protocolo {{{notificacao_s_m_s_request_protocolo_value}}} (optional)
     * @param int $nsu {{{notificacao_s_m_s_request_nsu_value}}} (optional)
     ...
     *
     * @param string $nsu {{{notificacao_resource_responder_s_m_s_get_param_nsu}}} (optional)
     * @param string $data {{{notificacao_resource_responder_s_m_s_get_param_data}}} (optional)
     * @param string $resposta {{{notificacao_resource_responder_s_m_s_get_param_resposta}}} (optional)
     * @return \br.com.conductor.pier.api.v2.model\NotificacaoSMSResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
     ...
     *
     * @param \br.com.conductor.pier.api.v2.model\PushFCMGCMPersistValue_[] $push_persists pushPersists (required)
     ...
     *
     * @param \br.com.conductor.pier.api.v2.model\PushAPNSPersistValue_[] $push_persists pushPersists (required)
     * @return \br.com.conductor.pier.api.v2.model\NotificacaoResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
     ...
     *
     * @param \br.com.conductor.pier.api.v2.model\SMSPersistValue_[] $lista_sms listaSMS (required)
     * @return \br.com.conductor.pier.api.v2.model\NotificacaoResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
     ...
     *
     * @param string $conteudo {{{notificacao_resource_salvar_template_notificacao_param_conteudo}}} (required)
     * @param int $id_configuracao_email {{{template_notificacao_persist_id_configuracao_email_value}}} (optional)
     * @param string $tipo_layout {{{template_notificacao_persist_tipo_layout_value}}} (optional)
     * @param string $tipo_notificacao {{{template_notificacao_persist_tipo_notificacao_value}}} (optional)
     * @param string $remetente {{{template_notificacao_persist_remetente_value}}} (optional)
