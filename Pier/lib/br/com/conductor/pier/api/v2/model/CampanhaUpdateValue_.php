...
use \ArrayAccess;
/**
 * CampanhaUpdateValue_ Class Doc Comment
 *
 * @category    Class
 * @description {{{campanha_update_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CampanhaUpdateValue_ implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'planos_campanhas' => '\br.com.conductor.pier.api.v2.model\PlanoCampanhaUpdateValue_[]'
    );
    ...
    /**
      * $nome {{{campanha_update_nome_value}}}
      * @var string
      */
    protected $nome;
    
    /**
      * $id_tipo_campanha {{{campanha_update_id_tipo_campanha_value}}}
      * @var int
      */
    protected $id_tipo_campanha;
    
    /**
      * $planos_campanhas {{{campanha_update_planos_campanhas_value}}}
      * @var \br.com.conductor.pier.api.v2.model\PlanoCampanhaUpdateValue_[]
      */
    ...
    /**
     * Sets nome
     * @param string $nome {{{campanha_update_nome_value}}}
     * @return $this
     */
     ...
     * @param int $id_tipo_campanha {{{campanha_update_id_tipo_campanha_value}}}
     * @return $this
     */
     ...
     * @return \br.com.conductor.pier.api.v2.model\PlanoCampanhaUpdateValue_[]
     */
     ...
     * @param \br.com.conductor.pier.api.v2.model\PlanoCampanhaUpdateValue_[] $planos_campanhas {{{campanha_update_planos_campanhas_value}}}
     * @return $this
     */
