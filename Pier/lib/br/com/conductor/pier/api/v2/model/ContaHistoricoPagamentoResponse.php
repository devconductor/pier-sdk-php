<?php
/**
 * ContaHistoricoPagamentoResponse
 *
 * PHP version 5
 *
 * @category Class
...
use \ArrayAccess;
/**
 * ContaHistoricoPagamentoResponse Class Doc Comment
 *
 * @category    Class
 * @description {{{conta_historico_pagamento_response_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContaHistoricoPagamentoResponse implements ArrayAccess
{
    /**
    ...
    /**
      * $id_pagamento {{{conta_historico_pagamento_response_id_pagamento_value}}}
      * @var int
      */
    protected $id_pagamento;
    
    /**
      * $id_estabelecimento {{{conta_historico_pagamento_response_id_estabelecimento_value}}}
      * @var int
      */
    protected $id_estabelecimento;
    
    /**
      * $id_banco {{{conta_historico_pagamento_response_id_banco_value}}}
      * @var int
      */
    protected $id_banco;
    
    /**
      * $id_cartao {{{conta_historico_pagamento_response_id_cartao_value}}}
      * @var int
      */
    protected $id_cartao;
    
    /**
      * $valor_pagamento {{{conta_historico_pagamento_response_valor_pagamento_value}}}
      * @var Number
      */
    protected $valor_pagamento;
    
    /**
      * $data_hora_pagamento {{{conta_historico_pagamento_response_data_hora_pagamento_value}}}
      * @var string
      */
    protected $data_hora_pagamento;
    
    /**
      * $data_hora_entrada_pagamento {{{conta_historico_pagamento_response_data_hora_entrada_pagamento_value}}}
      * @var string
      */
    protected $data_hora_entrada_pagamento;
    
    /**
      * $status {{{conta_historico_pagamento_response_status_value}}}
      * @var int
      */
    protected $status;
    ...
    /**
     * Sets id_pagamento
     * @param int $id_pagamento {{{conta_historico_pagamento_response_id_pagamento_value}}}
     * @return $this
     */
     ...
     * @param int $id_estabelecimento {{{conta_historico_pagamento_response_id_estabelecimento_value}}}
     * @return $this
     */
    ...
    /**
     * Sets id_banco
     * @param int $id_banco {{{conta_historico_pagamento_response_id_banco_value}}}
     * @return $this
     */
    ...
    /**
     * Sets id_cartao
     * @param int $id_cartao {{{conta_historico_pagamento_response_id_cartao_value}}}
     * @return $this
     */
     ...
     * @param Number $valor_pagamento {{{conta_historico_pagamento_response_valor_pagamento_value}}}
     * @return $this
     */
     ...
     * @param string $data_hora_pagamento {{{conta_historico_pagamento_response_data_hora_pagamento_value}}}
     * @return $this
     */
     ...
     * @param string $data_hora_entrada_pagamento {{{conta_historico_pagamento_response_data_hora_entrada_pagamento_value}}}
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param int $status {{{conta_historico_pagamento_response_status_value}}}
     * @return $this
     */
