...
use \ArrayAccess;
/**
 * UsuarioUpdateValue_ Class Doc Comment
 *
 * @category    Class
 * @description {{{usuario_update_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UsuarioUpdateValue_ implements ArrayAccess
{
    /**
    ...
    /**
      * $bloquear_acesso {{{usuario_update_bloquear_acesso_descricao}}}
      * @var bool
      */
     ...
     * @param bool $bloquear_acesso {{{usuario_update_bloquear_acesso_descricao}}}
     * @return $this
     */
