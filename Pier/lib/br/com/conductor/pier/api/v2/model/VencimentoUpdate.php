...
use \ArrayAccess;
/**
 * VencimentoUpdate Class Doc Comment
 *
 * @category    Class
 * @description {{{vencimento_update_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class VencimentoUpdate implements ArrayAccess
{
    /**
    ...
    /**
      * $data_prevista_corte {{{vencimento_update_data_prevista_corte_value}}}
      * @var string
      */
     ...
     * @param string $data_prevista_corte {{{vencimento_update_data_prevista_corte_value}}}
     * @return $this
     */
