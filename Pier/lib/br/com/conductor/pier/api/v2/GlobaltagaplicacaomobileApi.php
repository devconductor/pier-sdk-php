...
/**
 * GlobaltagaplicacaomobileApi Class Doc Comment
 *
 * @category Class
 * @package  br.com.conductor.pier.api.v2.invoker
 * @author   http://github.com/swagger-api/swagger-codegen
...
class GlobaltagaplicacaomobileApi
{
     ...
     * @return GlobaltagaplicacaomobileApi
     */
     ...
     *
     * @param int $id {{{aplicacao_mobile_resource_atualizar_param_id}}} (required)
     * @param \br.com.conductor.pier.api.v2.model\AplicacaoMobileUpdateValue_ $update update (required)
     ...
     * @param string $id {{{aplicacao_mobile_request_id_value}}} (optional)
     * @param int $id_plataforma_mobile {{{aplicacao_mobile_request_id_plataforma_mobile_value}}} (optional)
     ...
     *
     * @param \br.com.conductor.pier.api.v2.model\AplicacaoMobilePersistValue_ $persist persist (required)
     * @return \br.com.conductor.pier.api.v2.model\AplicacaoMobileResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
