 ...
 *
 * @category    Class
 * @description {{{cancelamento_transacao_on_us_request_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
...
class CancelamentoTransacaoOnUsRequest implements ArrayAccess
{
    ...
    /**
      * $nsu_autorizacao_transacao_cancelada {{{cancelamento_transacao_on_us_request_nsu_autorizacao_transacao_cancelada_value}}}
      * @var string
      */
    ...
    /**
      * $nsu_origem_transacao_cancelada {{{desfazimento_transacao_on_us_request_nsu_origem_transacao_cancelada_value}}}
      * @var string
      */
    ...
    /**
      * $data_hora_transacao_cancelada {{{desfazimento_transacao_on_us_request_data_hora_transacao_cancelada_value}}}
      * @var string
      */
     ...
     * @param string $nsu_autorizacao_transacao_cancelada {{{cancelamento_transacao_on_us_request_nsu_autorizacao_transacao_cancelada_value}}}
     * @return $this
     */
     ...
     * @param string $nsu_origem_transacao_cancelada {{{desfazimento_transacao_on_us_request_nsu_origem_transacao_cancelada_value}}}
     * @return $this
     */
     ...
     * @param string $data_hora_transacao_cancelada {{{desfazimento_transacao_on_us_request_data_hora_transacao_cancelada_value}}}
     * @return $this
     */
