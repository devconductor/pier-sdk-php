...
/**
 * GlobaltagjobApi Class Doc Comment
 *
 * @category Class
 * @package  br.com.conductor.pier.api.v2.invoker
 * @author   http://github.com/swagger-api/swagger-codegen
...
class GlobaltagjobApi
{
     ...
     * @param string $descricao {{{job_resource_atualizar_param_descricao}}} (required)
     * @param string $cron {{{job_resource_atualizar_param_cron}}} (required)
     * @param string $groovy groovy (required)
     * @return \br.com.conductor.pier.api.v2.model\JobResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function atualizarUsingPUT4($id, $descricao, $cron, $groovy)
    {
        list($response, $statusCode, $httpHeader) = $this->atualizarUsingPUT4WithHttpInfo ($id, $descricao, $cron, $groovy);
        return $response; 
    }
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function atualizarUsingPUT4WithHttpInfo($id, $descricao, $cron, $groovy)
    {
        ...
        if ($descricao === null) {
            throw new \InvalidArgumentException('Missing the required parameter $descricao when calling atualizarUsingPUT4');
        }
        // verify the required parameter 'cron' is set
        if ($cron === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cron when calling atualizarUsingPUT4');
        }
        // verify the required parameter 'groovy' is set
        if ($groovy === null) {
            throw new \InvalidArgumentException('Missing the required parameter $groovy when calling atualizarUsingPUT4');
        }
     ...
     * {{{job_resource_listar}}}
     *
     * @param string $groovy {{{job_d_t_o_groovy_value}}} (optional)
     * @param string $descricao {{{job_d_t_o_descricao_value}}} (optional)
     * @param string $cron {{{job_d_t_o_cron_value}}} (optional)
     * @param string $status {{{job_d_t_o_status_value}}} (optional)
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function listarUsingGET31($groovy = null, $descricao = null, $cron = null, $status = null, $page = null, $limit = null)
    {
        list($response, $statusCode, $httpHeader) = $this->listarUsingGET31WithHttpInfo ($groovy, $descricao, $cron, $status, $page, $limit);
        return $response; 
    }
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function listarUsingGET31WithHttpInfo($groovy = null, $descricao = null, $cron = null, $status = null, $page = null, $limit = null)
    {
     ...
     * {{{job_resource_salvar}}}
     *
     * @param string $descricao {{{job_resource_salvar_param_descricao}}} (required)
     * @param string $cron {{{job_resource_salvar_param_cron}}} (required)
     * @param string $groovy groovy (required)
     * @return \br.com.conductor.pier.api.v2.model\JobResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function salvarUsingPOST17($descricao, $cron, $groovy)
    {
        list($response, $statusCode, $httpHeader) = $this->salvarUsingPOST17WithHttpInfo ($descricao, $cron, $groovy);
        return $response; 
    }
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function salvarUsingPOST17WithHttpInfo($descricao, $cron, $groovy)
    {
        
        // verify the required parameter 'descricao' is set
        if ($descricao === null) {
            throw new \InvalidArgumentException('Missing the required parameter $descricao when calling salvarUsingPOST17');
        }
        // verify the required parameter 'cron' is set
        if ($cron === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cron when calling salvarUsingPOST17');
        }
        // verify the required parameter 'groovy' is set
        if ($groovy === null) {
            throw new \InvalidArgumentException('Missing the required parameter $groovy when calling salvarUsingPOST17');
        }
