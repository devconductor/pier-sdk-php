...
use \ArrayAccess;
/**
 * BoletoEmailRequest Class Doc Comment
 *
 * @category    Class
 * @description {{{boleto_email_request_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BoletoEmailRequest implements ArrayAccess
{
    /**
    ...
    /**
      * $email {{{boleto_email_request_value}}}
      * @var string
      */
    protected $email;
    
    /**
      * $id_template_notificacao {{{boleto_email_request_id_template_notificacao_value}}}
      * @var int
      */
    protected $id_template_notificacao;
    
    /**
      * $parametros {{{boleto_email_request_parametros_value}}}
      * @var object
      */
    ...
    /**
     * Sets email
     * @param string $email {{{boleto_email_request_value}}}
     * @return $this
     */
     ...
     * @param int $id_template_notificacao {{{boleto_email_request_id_template_notificacao_value}}}
     * @return $this
     */
    ...
    /**
     * Sets parametros
     * @param object $parametros {{{boleto_email_request_parametros_value}}}
     * @return $this
     */
