 ...
 *
 * @category    Class
 * @description {{{taxa_antecipacao_request_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
...
class TaxaAntecipacaoRequest implements ArrayAccess
{
    ...
    /**
      * $tipo_transacao {{{taxa_antecipacao_request_tipo_transacao_value}}}
      * @var string
      */
    protected $tipo_transacao;
    
    /**
      * $valor_taxa {{{taxa_antecipacao_request_valor_taxa_value}}}
      * @var Number
      */
    ...
    /**
     * Sets tipo_transacao
     * @param string $tipo_transacao {{{taxa_antecipacao_request_tipo_transacao_value}}}
     * @return $this
     */
    ...
    /**
     * Sets valor_taxa
     * @param Number $valor_taxa {{{taxa_antecipacao_request_valor_taxa_value}}}
     * @return $this
     */
