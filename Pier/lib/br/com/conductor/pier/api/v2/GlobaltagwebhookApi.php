...
/**
 * GlobaltagwebhookApi Class Doc Comment
 *
 * @category Class
 * @package  br.com.conductor.pier.api.v2.invoker
 * @author   http://github.com/swagger-api/swagger-codegen
...
class GlobaltagwebhookApi
{
     ...
     * @param \br.com.conductor.pier.api.v2.model\WebHookPersistValue_ $webhook webhook (required)
     * @param string $status {{{web_hook_resource_alterar_param_status}}} (optional)
     * @return \br.com.conductor.pier.api.v2.model\WebHookResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function alterarUsingPUT24($id, $webhook, $status = null)
    {
        list($response, $statusCode, $httpHeader) = $this->alterarUsingPUT24WithHttpInfo ($id, $webhook, $status);
        return $response; 
    }


    /**
     * alterarUsingPUT24WithHttpInfo
     *
     * {{{web_hook_resource_alterar}}}
     *
     * @param int $id {{{web_hook_resource_alterar_param_id}}} (required)
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function alterarUsingPUT24WithHttpInfo($id, $webhook, $status = null)
    {
        
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling alterarUsingPUT24');
        }
        // verify the required parameter 'webhook' is set
        if ($webhook === null) {
            throw new \InvalidArgumentException('Missing the required parameter $webhook when calling alterarUsingPUT24');
        }
     ...
     * @param int $id {{{web_hook_request_id_value}}} (optional)
     * @param string $tipo_evento {{{web_hook_request_tipo_evento_value}}} (optional)
     * @param string $metodo {{{web_hook_request_metodo_value}}} (optional)
     * @param string $url {{{web_hook_request_url_value}}} (optional)
