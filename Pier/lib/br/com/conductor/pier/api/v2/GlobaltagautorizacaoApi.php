...
/**
 * GlobaltagautorizacaoApi Class Doc Comment
 *
 * @category Class
 * @package  br.com.conductor.pier.api.v2.invoker
 * @author   http://github.com/swagger-api/swagger-codegen
...
class GlobaltagautorizacaoApi
{
     ...
     * @return GlobaltagautorizacaoApi
     */
     ...
     *
     * @param int $id {{{transacao_on_us_resource_autorizar_por_conta_param_id_conta}}} (required)
     ...
     * {{{transacao_on_us_resource_autorizar}}}
     *
     * @param int $id {{{transacao_on_us_resource_autorizar_param_id_cartao}}} (required)
     * @param \br.com.conductor.pier.api.v2.model\TransacaoOnUsPorIdCartaoRequest $transacao_on_us_por_id_cartao_request transacaoOnUsPorIdCartaoRequest (required)
     * @return \br.com.conductor.pier.api.v2.model\TransacaoOnUsResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
     ...
     *
     * @param int $id {{{transacao_on_us_resource_cancelar_por_id_conta_param_id_conta}}} (required)
     ...
     * {{{transacao_on_us_resource_cancelar}}}
     *
     * @param int $id {{{transacao_on_us_resource_cancelar_param_id_cartao}}} (required)
     * @param \br.com.conductor.pier.api.v2.model\CancelamentoTransacaoPorIdCartaoRequest $cancelamento_request cancelamentoRequest (required)
     * @return \br.com.conductor.pier.api.v2.model\TransacaoOnUsResponse
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
