...
use \ArrayAccess;
/**
 * ContaMultiAppPersistValue_ Class Doc Comment
 *
 * @category    Class
 * @description {{{conta_multi_app_persist_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContaMultiAppPersistValue_ implements ArrayAccess
{
    /**
    ...
    static $setters = array(
        ...
        'flag_fatura_digital' => 'setFlagFaturaDigital',
    ...
    static $getters = array(
        ...
        'flag_fatura_digital' => 'getFlagFaturaDigital',
    ...
    /**
      * $id_pessoa {{{conta_multi_app_persist_id_pessoa_value}}}
      * @var int
      */
    protected $id_pessoa;
    
    /**
      * $id_origem_comercial {{{conta_multi_app_persist_id_origem_comercial_value}}}
      * @var int
      */
    protected $id_origem_comercial;
    
    /**
      * $id_produto {{{conta_multi_app_persist_id_produto_value}}}
      * @var int
      */
    protected $id_produto;
    
    /**
      * $dia_vencimento {{{conta_multi_app_persist_dia_vencimento_value}}}
      * @var int
      */
    protected $dia_vencimento;
    
    /**
      * $valor_renda {{{conta_multi_app_persist_valor_renda_value}}}
      * @var Number
      */
    protected $valor_renda;
    
    /**
      * $valor_pontuacao {{{conta_multi_app_persist_valor_pontuacao_value}}}
      * @var int
      */
    protected $valor_pontuacao;
    
    /**
      * $id_endereco_correspondencia {{{conta_multi_app_persist_id_endereco_correspondencia_value}}}
      * @var int
      */
    protected $id_endereco_correspondencia;
    
    /**
      * $limite_global {{{conta_multi_app_persist_limite_global_value}}}
      * @var Number
      */
    protected $limite_global;
    
    /**
      * $limite_maximo {{{conta_multi_app_persist_limite_maximo_value}}}
      * @var Number
      */
    protected $limite_maximo;
    
    /**
      * $limite_parcelas {{{conta_multi_app_persist_limite_parcelas_value}}}
      * @var Number
      */
    protected $limite_parcelas;
    
    /**
      * $limite_consignado {{{conta_multi_app_persist_limite_consignado_value}}}
      * @var Number
      */
    protected $limite_consignado;
    
    /**
      * $flag_fatura_digital {{{conta_multi_app_persist_flag_fatura_por_email_value}}}
      * @var int
      */
    protected $flag_fatura_digital;
    
    /**
      * $canal_entrada {{{conta_multi_app_persist_canal_entrada_value}}}
      * @var string
      */
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->flag_fatura_digital = $data["flag_fatura_digital"];
    ...
    /**
     * Sets id_pessoa
     * @param int $id_pessoa {{{conta_multi_app_persist_id_pessoa_value}}}
     * @return $this
     */
     ...
     * @param int $id_origem_comercial {{{conta_multi_app_persist_id_origem_comercial_value}}}
     * @return $this
     */
    ...
    /**
     * Sets id_produto
     * @param int $id_produto {{{conta_multi_app_persist_id_produto_value}}}
     * @return $this
     */
    ...
    /**
     * Sets dia_vencimento
     * @param int $dia_vencimento {{{conta_multi_app_persist_dia_vencimento_value}}}
     * @return $this
     */
    ...
    /**
     * Sets valor_renda
     * @param Number $valor_renda {{{conta_multi_app_persist_valor_renda_value}}}
     * @return $this
     */
     ...
     * @param int $valor_pontuacao {{{conta_multi_app_persist_valor_pontuacao_value}}}
     * @return $this
     */
     ...
     * @param int $id_endereco_correspondencia {{{conta_multi_app_persist_id_endereco_correspondencia_value}}}
     * @return $this
     */
    ...
    /**
     * Sets limite_global
     * @param Number $limite_global {{{conta_multi_app_persist_limite_global_value}}}
     * @return $this
     */
    ...
    /**
     * Sets limite_maximo
     * @param Number $limite_maximo {{{conta_multi_app_persist_limite_maximo_value}}}
     * @return $this
     */
     ...
     * @param Number $limite_parcelas {{{conta_multi_app_persist_limite_parcelas_value}}}
     * @return $this
     */
     ...
     * @param Number $limite_consignado {{{conta_multi_app_persist_limite_consignado_value}}}
     * @return $this
     */
    ...
    /**
     * Gets flag_fatura_digital
     * @return int
     */
    public function getFlagFaturaDigital()
    {
        return $this->flag_fatura_digital;
    }
  
    /**
     * Sets flag_fatura_digital
     * @param int $flag_fatura_digital {{{conta_multi_app_persist_flag_fatura_por_email_value}}}
     * @return $this
     */
    public function setFlagFaturaDigital($flag_fatura_digital)
    {
        
        $this->flag_fatura_digital = $flag_fatura_digital;
        return $this;
    }
    ...
    /**
     * Sets canal_entrada
     * @param string $canal_entrada {{{conta_multi_app_persist_canal_entrada_value}}}
     * @return $this
     */
