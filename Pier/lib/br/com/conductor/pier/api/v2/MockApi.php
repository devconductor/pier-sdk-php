...
class MockApi
{
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function simularEmprestimoFinanciamentoUsingPOST($request)
    {
        list($response, $statusCode, $httpHeader) = $this->simularEmprestimoFinanciamentoUsingPOSTWithHttpInfo ($request);
        return $response; 
    }
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function simularEmprestimoFinanciamentoUsingPOSTWithHttpInfo($request)
    {
        ...
        // parse inputs
        $resourcePath = "/api/simular-emprestimos-financiamentos";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function visualizarDocumentoUsingPOST($id, $data_vencimento)
    {
        list($response, $statusCode, $httpHeader) = $this->visualizarDocumentoUsingPOSTWithHttpInfo ($id, $data_vencimento);
        return $response; 
    }


    /**
     * visualizarDocumentoUsingPOSTWithHttpInfo
     *
     * Permite visualizar o extrato da fatura em formato PDF
     *
     * @param int $id C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da conta (id). (required)
     ...
     * @throws \br.com.conductor.pier.api.v2.invoker\ApiException on non-2xx response
     */
    public function visualizarDocumentoUsingPOSTWithHttpInfo($id, $data_vencimento)
    {
        
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling visualizarDocumentoUsingPOST');
        }
        // verify the required parameter 'data_vencimento' is set
        if ($data_vencimento === null) {
            throw new \InvalidArgumentException('Missing the required parameter $data_vencimento when calling visualizarDocumentoUsingPOST');
        }
        ...
        try {
            ...
            return array(\br.com.conductor.pier.api.v2.invoker\ObjectSerializer::deserialize($response, 'ByteArray[]', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \br.com.conductor.pier.api.v2.invoker\ObjectSerializer::deserialize($e->getResponseBody(), 'ByteArray[]', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 201:
                $data = \br.com.conductor.pier.api.v2.invoker\ObjectSerializer::deserialize($e->getResponseBody(), 'ByteArray[]', $e->getResponseHeaders());
