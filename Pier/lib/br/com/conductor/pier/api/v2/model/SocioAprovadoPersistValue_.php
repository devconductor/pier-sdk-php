...
use \ArrayAccess;
/**
 * SocioAprovadoPersistValue_ Class Doc Comment
 *
 * @category    Class
 * @description {{{socio_aprovado_persist_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SocioAprovadoPersistValue_ implements ArrayAccess
{
    /**
    ...
    /**
      * $nome {{{socio_aprovado_persist_nome_value}}}
      * @var string
      */
    protected $nome;
    
    /**
      * $cpf {{{socio_aprovado_persist_cpf_value}}}
      * @var string
      */
    protected $cpf;
    
    /**
      * $data_nascimento {{{socio_aprovado_persist_data_nascimento_value}}}
      * @var string
      */
    protected $data_nascimento;
    
    /**
      * $sexo {{{socio_aprovado_persist_sexo_value}}}
      * @var string
      */
    protected $sexo;
    
    /**
      * $numero_identidade {{{socio_aprovado_persist_numero_identidade_value}}}
      * @var string
      */
    protected $numero_identidade;
    
    /**
      * $orgao_expedidor_identidade {{{socio_aprovado_persist_orgao_expedidor_identidade_value}}}
      * @var string
      */
    protected $orgao_expedidor_identidade;
    
    /**
      * $unidade_federativa_identidade {{{socio_aprovado_persist_unidade_federativa_identidade_value}}}
      * @var string
      */
    protected $unidade_federativa_identidade;
    
    /**
      * $data_emissao_identidade {{{socio_aprovado_persist_data_emissao_identidade_value}}}
      * @var string
      */
    protected $data_emissao_identidade;
    
    /**
      * $estado_civil {{{socio_aprovado_persist_estado_civil_value}}}
      * @var string
      */
    protected $estado_civil;
    
    /**
      * $profissao {{{socio_aprovado_persist_profissao_value}}}
      * @var string
      */
    protected $profissao;
    
    /**
      * $nacionalidade {{{socio_aprovado_persist_nacionalidade_value}}}
      * @var string
      */
    protected $nacionalidade;
    
    /**
      * $email {{{socio_aprovado_persist_email_value}}}
      * @var string
      */
    protected $email;
    
    /**
      * $telefones {{{socio_aprovado_persist_telefones_value}}}
    ...
    /**
     * Sets nome
     * @param string $nome {{{socio_aprovado_persist_nome_value}}}
     * @return $this
     */
    ...
    /**
     * Sets cpf
     * @param string $cpf {{{socio_aprovado_persist_cpf_value}}}
     * @return $this
     */
     ...
     * @param string $data_nascimento {{{socio_aprovado_persist_data_nascimento_value}}}
     * @return $this
     */
    ...
    /**
     * Sets sexo
     * @param string $sexo {{{socio_aprovado_persist_sexo_value}}}
     * @return $this
     */
     ...
     * @param string $numero_identidade {{{socio_aprovado_persist_numero_identidade_value}}}
     * @return $this
     */
     ...
     * @param string $orgao_expedidor_identidade {{{socio_aprovado_persist_orgao_expedidor_identidade_value}}}
     * @return $this
     */
     ...
     * @param string $unidade_federativa_identidade {{{socio_aprovado_persist_unidade_federativa_identidade_value}}}
     * @return $this
     */
     ...
     * @param string $data_emissao_identidade {{{socio_aprovado_persist_data_emissao_identidade_value}}}
     * @return $this
     */
    ...
    /**
     * Sets estado_civil
     * @param string $estado_civil {{{socio_aprovado_persist_estado_civil_value}}}
     * @return $this
     */
    ...
    /**
     * Sets profissao
     * @param string $profissao {{{socio_aprovado_persist_profissao_value}}}
     * @return $this
     */
    ...
    /**
     * Sets nacionalidade
     * @param string $nacionalidade {{{socio_aprovado_persist_nacionalidade_value}}}
     * @return $this
     */
    ...
    /**
     * Sets email
     * @param string $email {{{socio_aprovado_persist_email_value}}}
     * @return $this
     */
    ...
    /**
     * Sets telefones
     * @param \br.com.conductor.pier.api.v2.model\TelefonePessoaAprovadaPersistValue_[] $telefones {{{socio_aprovado_persist_telefones_value}}}
     * @return $this
     */
