 ...
 *
 * @category    Class
 * @description {{{transacao_pay_secure_request_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
...
class TransacaoPaySecureRequest implements ArrayAccess
{
    ...
    /**
      * $data_hora_transacao {{{transacao_pay_secure_request_data_hora_transacao_value}}}
      * @var string
      */
    ...
    /**
      * $valor {{{transacao_pay_secure_request_valor_value}}}
      * @var Number
      */
    protected $valor;
    
    /**
      * $nsu_origem {{{transacao_pay_secure_request_nsu_origem_value}}}
      * @var string
      */
    protected $nsu_origem;
    
    /**
      * $nome_portador_cartao {{{transacao_pay_secure_request_nome_portador_cartao_value}}}
      * @var string
      */
    protected $nome_portador_cartao;
    
    /**
      * $origem {{{transacao_pay_generic_request_origem_value}}}
      * @var string
      */
    protected $origem;
    
    /**
      * $terminal_requisitante {{{transacao_pay_secure_request_terminal_requisitante_value}}}
      * @var string
      */
    protected $terminal_requisitante;
    
    /**
      * $codigo_processamento {{{transacao_pay_secure_request_codigo_processamento_value}}}
      * @var string
      */
    protected $codigo_processamento;
    
    /**
      * $data_validade_cartao {{{transacao_pay_secure_request_data_validade_cartao_value}}}
      * @var string
      */
    protected $data_validade_cartao;
    
    /**
      * $numero_estabelecimento {{{transacao_pay_secure_request_numero_estabelecimento_value}}}
      * @var string
      */
    protected $numero_estabelecimento;
    
    /**
      * $numero_parcelas {{{transacao_pay_secure_request_numero_parcelas_value}}}
      * @var int
      */
    protected $numero_parcelas;
    
    /**
      * $codigo_seguranca_cartao {{{transacao_pay_secure_request_codigo_seguranca_cartao_value}}}
      * @var string
      */
     ...
     * @param string $data_hora_transacao {{{transacao_pay_secure_request_data_hora_transacao_value}}}
     * @return $this
     */
    ...
    /**
     * Sets valor
     * @param Number $valor {{{transacao_pay_secure_request_valor_value}}}
     * @return $this
     */
    ...
    /**
     * Sets nsu_origem
     * @param string $nsu_origem {{{transacao_pay_secure_request_nsu_origem_value}}}
     * @return $this
     */
     ...
     * @param string $nome_portador_cartao {{{transacao_pay_secure_request_nome_portador_cartao_value}}}
     * @return $this
     */
    ...
    /**
     * Sets origem
     * @param string $origem {{{transacao_pay_generic_request_origem_value}}}
     * @return $this
     */
     ...
     * @param string $terminal_requisitante {{{transacao_pay_secure_request_terminal_requisitante_value}}}
     * @return $this
     */
     ...
     * @param string $codigo_processamento {{{transacao_pay_secure_request_codigo_processamento_value}}}
     * @return $this
     */
     ...
     * @param string $data_validade_cartao {{{transacao_pay_secure_request_data_validade_cartao_value}}}
     * @return $this
     */
     ...
     * @param string $numero_estabelecimento {{{transacao_pay_secure_request_numero_estabelecimento_value}}}
     * @return $this
     */
     ...
     * @param int $numero_parcelas {{{transacao_pay_secure_request_numero_parcelas_value}}}
     * @return $this
     */
     ...
     * @param string $codigo_seguranca_cartao {{{transacao_pay_secure_request_codigo_seguranca_cartao_value}}}
     * @return $this
     */
