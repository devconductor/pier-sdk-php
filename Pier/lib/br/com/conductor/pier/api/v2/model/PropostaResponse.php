...
use \ArrayAccess;
/**
 * PropostaResponse Class Doc Comment
 *
 * @category    Class
 * @description {{{proposta_response_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PropostaResponse implements ArrayAccess
{
    /**
    ...
    /**
      * $id {{{proposta_response_id_value}}}
      * @var int
      */
    protected $id;
    
    /**
      * $status {{{proposta_response_status_value}}}
      * @var int
      */
    protected $status;
    
    /**
      * $data_cadastramento {{{proposta_response_data_cadastramento_value}}}
      * @var string
      */
    ...
    /**
     * Sets id
     * @param int $id {{{proposta_response_id_value}}}
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param int $status {{{proposta_response_status_value}}}
     * @return $this
     */
     ...
     * @param string $data_cadastramento {{{proposta_response_data_cadastramento_value}}}
     * @return $this
     */
