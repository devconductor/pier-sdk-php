 ...
 *
 * @category    Class
 * @description {{{alterar_produto_request_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
...
class AlterarProdutoRequest implements ArrayAccess
{
    ...
    /**
      * $id_produto {{{alterar_produto_request_id_produto_value}}}
      * @var int
      */
    protected $id_produto;
    
    /**
      * $id_origem_comercial {{{alterar_produto_request_id_origem_comercial_value}}}
      * @var int
      */
    protected $id_origem_comercial;
    
    /**
      * $id_estabelecimento {{{alterar_produto_request_id_estabelecimento_value}}}
      * @var int
      */
    protected $id_estabelecimento;
    
    /**
      * $id_promotor {{{alterar_produto_request_id_promotor_value}}}
      * @var int
      */
    ...
    /**
     * Sets id_produto
     * @param int $id_produto {{{alterar_produto_request_id_produto_value}}}
     * @return $this
     */
     ...
     * @param int $id_origem_comercial {{{alterar_produto_request_id_origem_comercial_value}}}
     * @return $this
     */
     ...
     * @param int $id_estabelecimento {{{alterar_produto_request_id_estabelecimento_value}}}
     * @return $this
     */
    ...
    /**
     * Sets id_promotor
     * @param int $id_promotor {{{alterar_produto_request_id_promotor_value}}}
     * @return $this
     */
