...
use \ArrayAccess;
/**
 * TerminalUpdateValue_ Class Doc Comment
 *
 * @category    Class
 * @description {{{terminal_update_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TerminalUpdateValue_ implements ArrayAccess
{
    /**
    ...
    /**
      * $flag_consulta_extrato {{{terminal_update_flag_consulta_extrato_value}}}
      * @var bool
      */
    protected $flag_consulta_extrato;
    
    /**
      * $flag_terminal_virtual {{{terminal_update_flag_terminal_virtual_value}}}
      * @var bool
      */
     ...
     * @param bool $flag_consulta_extrato {{{terminal_update_flag_consulta_extrato_value}}}
     * @return $this
     */
     ...
     * @param bool $flag_terminal_virtual {{{terminal_update_flag_terminal_virtual_value}}}
     * @return $this
     */
