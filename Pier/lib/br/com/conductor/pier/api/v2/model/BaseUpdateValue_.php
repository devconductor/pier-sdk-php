...
use \ArrayAccess;
/**
 * BaseUpdateValue_ Class Doc Comment
 *
 * @category    Class
 * @description {{{base_update_description}}}
 * @package     br.com.conductor.pier.api.v2.invoker
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BaseUpdateValue_ implements ArrayAccess
{
    /**
    ...
    /**
      * $servidor {{{base_update_servidor_value}}}
      * @var string
      */
    protected $servidor;
    
    /**
      * $usuario {{{base_update_usuario_value}}}
      * @var string
      */
    protected $usuario;
    
    /**
      * $senha {{{base_update_senha_value}}}
      * @var string
      */
    protected $senha;
    
    /**
      * $nome_base {{{base_update_nome_base_value}}}
      * @var string
      */
    protected $nome_base;
    
    /**
      * $alterado_por {{{base_update_alterado_por_value}}}
      * @var string
      */
    protected $alterado_por;
    
    /**
      * $domain {{{base_update_domain_value}}}
      * @var string
      */
    protected $domain;
    
    /**
      * $senha_criptografada {{{base_update_senha_criptografada_value}}}
      * @var bool
      */
    protected $senha_criptografada;
    
    /**
      * $nome_base_controle_acesso {{{base_update_nome_base_controle_acesso_value}}}
      * @var string
      */
    protected $nome_base_controle_acesso;
    
    /**
      * $id_emissor {{{base_update_id_emissor_value}}}
      * @var int
      */
    protected $id_emissor;
    
    /**
      * $servidor_controle_acesso {{{base_update_servidor_controle_acesso_value}}}
      * @var string
      */
    protected $servidor_controle_acesso;
    
    /**
      * $nome_base_usuarios {{{base_update_nome_base_usuarios_value}}}
      * @var string
      */
    protected $nome_base_usuarios;
    
    /**
      * $servidor_usuarios {{{base_update_servidor_usuarios_value}}}
      * @var string
      */
    protected $servidor_usuarios;
    
    /**
      * $flag_cluster {{{base_update_flag_cluster_value}}}
      * @var bool
      */
    ...
    /**
     * Sets servidor
     * @param string $servidor {{{base_update_servidor_value}}}
     * @return $this
     */
    ...
    /**
     * Sets usuario
     * @param string $usuario {{{base_update_usuario_value}}}
     * @return $this
     */
    ...
    /**
     * Sets senha
     * @param string $senha {{{base_update_senha_value}}}
     * @return $this
     */
    ...
    /**
     * Sets nome_base
     * @param string $nome_base {{{base_update_nome_base_value}}}
     * @return $this
     */
    ...
    /**
     * Sets alterado_por
     * @param string $alterado_por {{{base_update_alterado_por_value}}}
     * @return $this
     */
    ...
    /**
     * Sets domain
     * @param string $domain {{{base_update_domain_value}}}
     * @return $this
     */
     ...
     * @param bool $senha_criptografada {{{base_update_senha_criptografada_value}}}
     * @return $this
     */
     ...
     * @param string $nome_base_controle_acesso {{{base_update_nome_base_controle_acesso_value}}}
     * @return $this
     */
    ...
    /**
     * Sets id_emissor
     * @param int $id_emissor {{{base_update_id_emissor_value}}}
     * @return $this
     */
     ...
     * @param string $servidor_controle_acesso {{{base_update_servidor_controle_acesso_value}}}
     * @return $this
     */
     ...
     * @param string $nome_base_usuarios {{{base_update_nome_base_usuarios_value}}}
     * @return $this
     */
     ...
     * @param string $servidor_usuarios {{{base_update_servidor_usuarios_value}}}
     * @return $this
     */
    ...
    /**
     * Sets flag_cluster
     * @param bool $flag_cluster {{{base_update_flag_cluster_value}}}
     * @return $this
     */
